	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	const FRealCurve* ArmorPenetrationCruve = CharacterClassInfo->DamageCalculationCoefficients->FindCurve(FName("ArmorPenetration"), FString());
	const float ArmorPenetrationCoefficient = ArmorPenetrationCruve->Eval(SourceCombatInterface->GetPlayerLevel());
	...
	// If Block, halve the SourceCriticalHitDamage.	
	SourceCriticalHitDamage = bBlocked ? SourceCriticalHitDamage / 2.f : SourceCriticalHitDamage;
