...
void UOverlayWidgetController::BindCallbacksToDependencies()
{
	...
	AURACAST(UAuraAbilitySystemComponent, AbilitySystemComponent)->EffectAssetTagsDelegate.AddLambda(
		[this](const FGameplayTagContainer& AssetTags)
		{
			for (const FGameplayTag& Tag : AssetTags)
			{
				...
				{
					// const FString Msg = FString::Printf(TEXT("GM Tag: %s"), *Tag.ToString());
